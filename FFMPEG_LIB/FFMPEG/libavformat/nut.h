...
#define      MAIN_STARTCODE ((uint64_t)0x7A561F5F04AD + (((uint64_t)('N'<<8) + 'M')<<48))
#define    STREAM_STARTCODE ((uint64_t)0x11405BF2F9DB + (((uint64_t)('N'<<8) + 'S')<<48))
#define SYNCPOINT_STARTCODE ((uint64_t)0xE4ADEECA4569 + (((uint64_t)('N'<<8) + 'K')<<48))
#define     INDEX_STARTCODE ((uint64_t)0xDD672F23E64E + (((uint64_t)('N'<<8) + 'X')<<48))
#define      INFO_STARTCODE ((uint64_t)0xAB68B596BA78 + (((uint64_t)('N'<<8) + 'I')<<48))
