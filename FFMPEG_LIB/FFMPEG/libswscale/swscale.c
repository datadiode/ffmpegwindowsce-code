...
#ifdef UNDER_CE
    c->uOffset=   (int64_t)0x0400040004000400;
    c->vOffset=   (int64_t)0x0400040004000400;
#else
...
#ifdef UNDER_CE
    c->yCoeff=    roundToInt16(cy *8192) * (uint64_t)0x0001000100010001;
    c->vrCoeff=   roundToInt16(crv*8192) * (uint64_t)0x0001000100010001;
    c->ubCoeff=   roundToInt16(cbu*8192) * (uint64_t)0x0001000100010001;
    c->vgCoeff=   roundToInt16(cgv*8192) * (uint64_t)0x0001000100010001;
    c->ugCoeff=   roundToInt16(cgu*8192) * (uint64_t)0x0001000100010001;
    c->yOffset=   roundToInt16(oy *   8) * (uint64_t)0x0001000100010001;
#else
...
#ifdef UNDER_CE
    c->vRounder= 4* (uint64_t)0x0001000100010001;
#else
